function [Xfit, Yfit, Zfit, Xgof, Ygof, Zgof] = fitFoci_gof(ImageStack, roiList, Index, Index2)
% updated on 190626 to redefine MaxIntensity from the raw images for the
...
Y0 = Y0(1);
X0 = X0(1);
MaxIntensity = CropedImage(Y0,X0,I); % updated on 190626
...
[f1, Xgof] = fit((X0-3:X0+3)', Data1', GaussEqu, 'Start', StartPoint1);
[f2, Ygof] = fit((Y0-3:Y0+3)', Data2, GaussEqu, 'Start', StartPoint2);
...
[f3, Zgof] = fit(Irange', Data3, GaussEqu, 'Start', StartPoint3);
